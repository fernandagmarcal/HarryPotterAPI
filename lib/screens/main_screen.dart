...
class MainScreen extends StatefulWidget {
  ...
  final String messageErrorDescription =
...
//Vai gerenciar os estados e a renderizacao da cena MainScreen
// MainsScreenState é um estado que vai gerenciar a tela mainscreen

class _MainScreenState extends State<MainScreen> {
  int _mainScreenState = 2; // 0: sucesso, 1: erro, 2: carregando
